...
public:
    ...
    T getX() const; // значение координаты X
    T getY() const; // значение координаты Y

    Point& operator=(const Point& other);
    Point& operator=(Point&& other) noexcept;

    bool operator==(const Point& other) const; // сравнение - равенство
    bool operator<(const Point& other) const; // сравнение - "меньше"
